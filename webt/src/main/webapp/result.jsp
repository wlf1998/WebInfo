<%@ page import = "base.Searcher,java.util.Map, java.util.ArrayList" %>
...
<%
    ...
    if(queryText != null){
        ...
        totalResults = Searcher.search(indexDir,queryText);
        ...
        if(results != null && results.size() != 0 ){
            ...
            for(int i = 0 ; i < results.size() ; i ++){
                ...
                out.println("</font>" + "<br>");
                out.println("<font color = \"black\" size = \"1\">" + "<strong>score</strong>: " + "strScore" + 
